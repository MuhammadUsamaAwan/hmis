...
import { Select, type SingleSelectProps } from "./select";
...
export const MultiSelect: Story = {
  render: () => <Select multiple label="Tests" placeholder="Select tests" items={GROUPED_OPTIONS} />,
};

export const MultiSelectWithDefaults: Story = {
  render: () => (
    <Select multiple label="Tests" placeholder="Select tests" defaultValue={["bp", "cbc"]} items={GROUPED_OPTIONS} />
  ),
};
...
export const LargeList: Story = {
  render: () => <Select label="Diagnosis (ICD-10)" placeholder="Search 500 codes..." items={ICD_CODES} />,
};

export const LargeListMulti: Story = {
  render: () => <Select multiple label="Diagnoses (ICD-10)" placeholder="Search 500 codes..." items={ICD_CODES} />,
};
